...
<template>
  <div class="relative w-[60px] z-50 flex justify-center items-center">
    ...
    <ul class="flex w-[100px] overflow-hidden rounded-lg z-50 bg-white shadow-lg dark:bg-[#2F3349FF] right-[-20px] top-[-5px] flex-col transition-all ease-linear absolute scale-0" :class="{ '!z-50 !scale-100 !right-[-2px] !top-[42px]': isLocales }">
