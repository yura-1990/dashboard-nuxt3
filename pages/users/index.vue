...
function handleShowModal(e: any){
  ...
  if (toggleModal.value){
    ...
    document.body.classListNaNpxove('overflow-hidden')
  }
}
...
async function prevNextPage(url: string){
  if (url) {
        ...
        <div class="inline-block min-w-full align-middle">
          <div class="overflow-hidden shadow sm:rounded-lg">
            <div class="p-1 flex items-center justify-between">
              <div></div>
              <!-- Modal toggle -->
              <button @click="handleShowModal" type="button"
              ...
              <div @click="outsideClick" :class="toggleModal ? 'flex ' : 'hidden'"
                ...
                $t('password') }}</label>
                      ...
                      <div class="mb-5">
                        ...
                        <input type="password" v-model="form.password_confirmation" id="repeat-password"
                          class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-[#2F3349FF] dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                          required />
                      </div>
                      ...
                      <div class="mb-5">
                        ...
                        <select id="countries" v-model="form.roles" multiple
                          ...
                          <option v-for="(item, index) in roleLists " :key="index" :value="item.id">
                ...
                <tr v-for="(item, index) in userLists.data" :key="index"
                  ...
                  <td
                    ...
                    <div class="flex justify-end gap-2 items-center">
                      <button v-if="permissions?.find((el)=>el==='Read Users')">
                      ...
                      <button v-if="permissions?.find((el)=>el==='Update Users')">
                      ...
                      <button v-if="permissions?.find((el)=>el==='Delete Users')">
                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
    ...
    <div class="flex items-center justify-center pt-1 sm:pt-2">
      <nav aria-label="Page navigation example">
        <ul class="inline-flex -space-x-px text-sm">
          <li>
            <button :disabled="!userLists?.prev_page_url" @click="prevNextPage(userLists?.prev_page_url)" class="flex items-center justify-center px-3 h-8 ms-0 leading-tight text-gray-500 bg-white border border-e-0 border-gray-300 rounded-s-lg hover:bg-gray-100 hover:text-black dark:bg-[#2F2B3DFF] dark:border-gray-700 dark:text-white dark:hover:bg-[#2F3349FF] dark:hover:text-white">
              &laquo; {{ $t('previous') }}
            </button>
          </li>
          <li v-for="page in userLists.last_page">
