...
const userID = computed( () => useCookie('userId'))

onMounted(async ()=>{
  await getOneUser(userID.value.value)
...
const links = ref([
  ...
  {
    title: 'show',
    icon: { name: 'ic:outline-manage-accounts', size: '16' },
    to: '/users/show',
  }
])
        ...
        <div class="col-span-full xl:col-auto">
          <div class="p-4 mb-4 bg-white border border-gray-200 rounded-lg shadow-sm 2xl:col-span-2 dark:border-gray-700 sm:p-6 dark:bg-[#2F3349FF]">
            <div class="items-center sm:flex xl:block 2xl:flex sm:space-x-4 xl:space-x-0 2xl:space-x-4">
              ...
              <div>
                <h3 class="mb-1 text-xl font-bold text-gray-900 dark:text-white">{{  oneUser.name }}</h3>
                <div class="mb-4 text-sm text-gray-500 dark:text-gray-400">
                  {{ oneUser.email }}
                </div>
                <div class="flex items-center space-x-4">
                  <button type="button" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white rounded-lg bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 active-link dark:focus:ring-primary-800">
