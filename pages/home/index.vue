  ...
  <div class="p-4 bg-white border border-gray-200 rounded-lg shadow-sm dark:border-gray-700 sm:p-6 dark:bg-[#2F3349FF] mt-2">
      ...
      <div class="items-center justify-between lg:flex">
        ...
        <div class="items-center sm:flex">
          <div class="flex items-center">
            <button id="dropdownDefault" data-dropdown-toggle="dropdown" class="mb-4 sm:mb-0 mr-4 inline-flex items-center text-gray-900 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-sm px-4 py-2.5 dark:bg-[#2F3349FF] dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700" type="button">
              Filter by status
            ...
            <!-- Dropdown menu -->
            <div id="dropdown" class="z-10 w-56 p-3 bg-white rounded-lg shadow dark:bg-gray-700 hidden" style="position: absolute; inset: 0rem auto auto 0rem; margin: 0rem; transform: translate(75.9375rem, 189.125rem);" data-popper-placement="bottom">
          ...
          <div class="inline-block min-w-full align-middle">
            <div class="overflow-hidden shadow sm:rounded-lg">
              <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
                <thead class="bg-gray-50 dark:bg-[#2f2b3d49] ">
                  <tr>
                ...
                <tbody class="bg-white dark:bg-[#2F3349FF]">
                  <tr>
                  ...
                  <tr class="bg-gray-50 dark:bg-[#2F3349FF]">
                    <td class="p-4 text-sm font-normal text-gray-900 whitespace-nowrap dark:text-white">
      ...
      <div class="flex items-center justify-between pt-3 sm:pt-6">
        <div>
          ...
          <!-- Dropdown menu -->
          <div class="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow dark:bg-gray-700 dark:divide-gray-600" id="transactions-dropdown" data-popper-placement="top" style="position: absolute; inset: auto auto 0rem 0rem; margin: 0rem; transform: translate(22.1875rem, 208.8125rem);" data-popper-reference-hidden="" data-popper-escaped="">
